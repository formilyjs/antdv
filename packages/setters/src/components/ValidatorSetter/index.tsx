...
import { FoldItem, DrawerSetter, ValueInput } from '@formily/antdv-settings-form'
          ...
          array: {
            ...
            items: {
              ...
              properties: {
                ...
                drawer: {
                  ...
                  title: GlobalRegistry.getDesignerMessage('settings.x-validator.drawer'),
                  properties: {
                    triggerType: {
                      type: 'string',
                    ...
                    format: {
                      type: 'string',
                      title: GlobalRegistry.getDesignerMessage('settings.x-validator.format.title'),
                      'x-decorator': 'FormItem',
                      'x-component': 'Select',
                      'x-component-props': {
                        allowClear: true,
                    ...
                    pattern: {
                      type: 'string',
                      title: GlobalRegistry.getDesignerMessage('settings.x-validator.pattern'),
                      'x-decorator': 'FormItem',
                      'x-component': 'Input',
                      'x-component-props': {
                        prefix: '/',
                    ...
                    len: {
                      type: 'string',
                      title: GlobalRegistry.getDesignerMessage('settings.x-validator.len'),
                      'x-decorator': 'FormItem',
                      'x-component': 'InputNumber'
                    },
                    max: {
                      title: GlobalRegistry.getDesignerMessage('settings.x-validator.max'),
                      type: 'string',
                      'x-decorator': 'FormItem',
                      'x-component': 'InputNumber'
                    },
                    min: {
                      type: 'string',
                      title: GlobalRegistry.getDesignerMessage('settings.x-validator.min'),
                      'x-decorator': 'FormItem',
                      'x-component': 'InputNumber'
                    },
                    exclusiveMaximum: {
                    ...
                    whitespace: {
                      type: 'string',
                      title: GlobalRegistry.getDesignerMessage('settings.x-validator.whitespace'),
                      'x-decorator': 'FormItem',
                      'x-component': 'Switch'
                    },
                    required: {
                      type: 'string',
                      title: GlobalRegistry.getDesignerMessage('settings.x-validator.required'),
                      'x-decorator': 'FormItem',
                      'x-component': 'Switch'
                    }
                  }
            ...
            properties: {
              addValidatorRules: {
                ...
                title: GlobalRegistry.getDesignerMessage('settings.x-validator.addValidatorRules')
              }
            }
          }
        }
